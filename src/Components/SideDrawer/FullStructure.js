    ...
    <div>
      ...
      <Drawer variant="permanent" open={open} style={{ fontSize: "10px" }}>
          ...
          >
            ...
            <IconButton onClick={handleDrawerClose}>
              {theme.direction === "rtl" ? (
                ...
                <VscArrowLeft style={{ color: "white" }} />
              )}
            </IconButton>
          </div>
        </div>
        ...
        {SideLinksDash.map((menuItems, index) => (
          ...
          >
            {activeIcon === index ? (
              ...
              // ""
              <ListItemIcon style={{ fontSize: "25px" }}>
                {menuItems.icon}
              </ListItemIcon>
            )}

            <ListItemText style={{ color: "#099F19", fontSize: "10px" }}  primary={menuItems.name} />
          </ListItem>
        ))}
        ...
        <ListItem>
          ...
          <ListItemText style={{ color: "gray" , textShadow: "0 1px 1px black" }}>প্রতিষ্ঠান</ListItemText>
        </ListItem>
        ...
        <ListItem>
          ...
          <ListItemText style={{ color: "gray", textShadow: "0 1px 1px black" }}>ব্যবহারকারী</ListItemText>
        </ListItem>
        ...
        {SideLinksUsers.map((menuItems, index) => (
          ...
          >
            <ListItemText style={{ fontSize: "25px", color: "#099F19" }} primary={"- "+menuItems.name} />
          </ListItem>
        ))}
